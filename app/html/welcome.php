...
<head>
    ...
    <!-- Gritter -->
    <link href="./_static/js/plugins/gritter/jquery.gritter.css" rel="stylesheet">
</head>
...
<div class="wrapper wrapper-content">
    <div class="row">
        <div class="col-sm-12">
            ...
            <p>3、请将您的登陆密码设置为10-16位，并用字符和字母及数字组合。 </p>
            <p>4、如系统有任何的操作异常，请截图保存并及时的联系管理员。</p>
        </div>
        <div class="col-sm-3 div_hidden">
...
<script src="./_static/js/plugins/flot/jquery.flot.js"></script>
<script type="text/javascript" src="./_static/js/welcome.js"></script>
</body>
</html>
